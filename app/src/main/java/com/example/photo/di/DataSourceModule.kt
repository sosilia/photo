...
abstract class DataSourceModule {
    ...
    @Binds
    abstract fun bindPhotoDataSource(photoRemoteDataSource: PhotoRemoteDataSource) : PhotoDataSource

    @Binds
    abstract fun bindBookmarkDataSource(bookmarkLocalDataSource: BookmarkLocalDataSource) : BookmarkDataSource
}